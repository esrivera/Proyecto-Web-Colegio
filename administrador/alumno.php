          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-3">
                <div class="card card-primary card-outline">
                  <div class="card-header">
                    <h5 class="card-title m-0">Agregar Alumno</h5>
                  </div>
                  <div class="card-body">
                    <a href="agregar_alumno.php" class="btn btn-primary">Ingresar&nbsp&nbsp&nbsp<i
              ...
              <div class="col-lg-3">
                <div class="card card-primary card-outline">
                  <div class="card-header">
                    <h5 class="card-title m-0">Listar Alumnos</h5>
                  </div>
                  <div class="card-body">
                    <a href="listar_alumno.php" class="btn btn-primary">Ingresar&nbsp&nbsp&nbsp<i
                        class="fas fa-arrow-circle-right"></i></a>
                  </div>
                </div>
              </div>
