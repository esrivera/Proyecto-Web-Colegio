                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-3">
                                <div class="card card-primary card-outline">
                                    <div class="card-header">
                                        <h5 class="card-title m-0">Agregar Representante</h5>
                                    </div>
                                    <div class="card-body">
                                        <a href="agregar_representante.php" class="btn btn-primary">Ingresar&nbsp&nbsp&nbsp<i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <!-- /.col-md-6 -->
                            <div class="col-lg-3">
                                <div class="card card-primary card-outline">
                                    <div class="card-header">
                                        <h5 class="card-title m-0">Listar Representantes</h5>
                                    </div>
                                    <div class="card-body">
                                        <a href="listar_representante.php" class="btn btn-primary">Ingresar&nbsp&nbsp&nbsp<i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <!-- /.col-md-6 -->
