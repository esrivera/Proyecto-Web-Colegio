                                                ...
                                                if ($result) {
                                                    while ($row = $result->fetch_assoc()) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="editar_docente.php?update=<?php echo $row['COD_PERSONA']; ?>" title="Editar datos" name="modificar" class="btn btn-primary btn-sm"><span class="far fa-edit fa-lg" aria-hidden="true"></span></a>
                                                                <a href="listar_docente.php?delete=<?php echo $row['COD_PERSONA']; ?>" title="Eliminar" name="eliminar" class="btn btn-danger btn-sm"><span class="far fa-trash-alt fa-lg" aria-hidden="true"></span></a>
                                                            </td>
                                                        </tr>
                                                    <?php }
                                                } else { ?>
