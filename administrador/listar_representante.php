                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <form method="get" action="listar_representante.php">
                                            <div class="card-tools">
                                                <div class="input-group input-group-sm" style="width: 250px;">
                                                    ...
                                                    <div class="input-group-append">
                                                        <a type="submit" href="listar_representante.php" name="accion" value="Refrescar" class="btn btn-default"><i class="fas fa-list"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                                ...
                                                if ($result) {
                                                    while ($row = $result->fetch_assoc()) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="editar_representante.php?update=<?php echo $row['COD_PERSONA']; ?>" title="Editar datos" name="modificar" class="btn btn-primary btn-sm"><span class="far fa-edit fa-lg" aria-hidden="true"></span></a>
                                                                <a href="listar_representante.php?delete=<?php echo $row['COD_PERSONA']; ?>" title="Eliminar" name="eliminar" class="btn btn-danger btn-sm"><span class="far fa-trash-alt fa-lg" aria-hidden="true"></span></a>
                                                            </td>
                                                        </tr>
                                                    <?php }
                                                } else { ?>
